...
import { EmbassyLetterSubmission, getStatusLabel, getStatusColor } from '../../types/submissions';

interface EmbassyLetterHistoryProps {
  onBack: () => void;
  onViewSubmission: (submission: EmbassyLetterSubmission) => void;
  language: 'en' | 'my';
}

export function EmbassyLetterHistory({ onBack, onViewSubmission, language }: EmbassyLetterHistoryProps) {
    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="bg-[#224e4a] px-4 pt-12 pb-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="text-white font-semibold">Embassy Letter History</h1>
          ...
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Your Embassy Letter requests will appear here
              </p>
            </CardContent>
          </Card>
        ) : (
              ...
              <CardContent className="p-4">
                ...
                <div className="space-y-1 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{submission.purposeOfLetter}</span>
                  </div>
                  <div className="flex justify-between">
