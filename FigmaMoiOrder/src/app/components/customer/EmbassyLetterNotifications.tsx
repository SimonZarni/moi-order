...
interface EmbassyLetterNotificationsProps {
  onBack: () => void;
  onViewSubmission: (id: string) => void;
  language: 'en' | 'my';
}

export function EmbassyLetterNotifications({ onBack, onViewSubmission, language }: EmbassyLetterNotificationsProps) {
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="sticky top-0 z-10 bg-white border-b border-border px-4 py-4">
        <div className="flex items-center gap-3">
          ...
          <h1>{language === 'en' ? 'Embassy Letter - Notifications' : 'သံရုံးစာ - အကြောင်းကြားချက်များ'}</h1>
        </div>
      </div>
                    ...
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {language === 'en' ? 'Purpose:' : 'ရည်ရွယ်ချက်:'} {submission.purposeOfLetter}
                        </p>
                      </div>
