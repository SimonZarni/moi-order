...
interface NinetyDaysNotificationsProps {
  onBack: () => void;
  onViewSubmission: (id: string) => void;
  language: 'en' | 'my';
}

export function NinetyDaysNotifications({ onBack, onViewSubmission, language }: NinetyDaysNotificationsProps) {
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="sticky top-0 z-10 bg-white border-b border-border px-4 py-4">
        <div className="flex items-center gap-3">
          ...
          <h1>{language === 'en' ? '90 Days Report - Notifications' : '90 ရက် အစီရင်ခံစာ - အကြောင်းကြားချက်များ'}</h1>
        </div>
      </div>
                    ...
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {language === 'en' ? 'Passport:' : 'နိုင်ငံကူးလက်မှတ်:'} {submission.passportNumber}
                        </p>
                      </div>
