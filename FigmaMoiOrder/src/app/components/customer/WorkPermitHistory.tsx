...
import { WorkPermitSubmission, getStatusLabel, getStatusColor } from '../../types/submissions';

interface WorkPermitHistoryProps {
  onBack: () => void;
  onViewSubmission: (submission: WorkPermitSubmission) => void;
  language: 'en' | 'my';
}

export function WorkPermitHistory({ onBack, onViewSubmission, language }: WorkPermitHistoryProps) {
    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="bg-[#224e4a] px-4 pt-12 pb-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="text-white font-semibold">Work Permit History</h1>
          ...
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Your Work Permit applications will appear here
              </p>
            </CardContent>
          </Card>
        ) : (
              ...
              <CardContent className="p-4">
                ...
                <div className="space-y-1 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{submission.employerName}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Position:</span>
                    <span className="font-medium">{submission.jobPosition}</span>
                  </div>
                  <div className="flex justify-between">
