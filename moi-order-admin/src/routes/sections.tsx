...
export const FoodInvoicesPage = lazy(() => import('src/pages/food-invoices'));
...
export const TBPeopleDetailPage = lazy(() => import('src/pages/tb-people-detail'));
export const TBTemplatesPage = lazy(() => import('src/pages/tb-templates'));
export const TBTodoPage = lazy(() => import('src/pages/tb-todo'));
...
export const routesSection: RouteObject[] = [
  {
    ...
    children: [
      ...
      { path: 'food-invoices', element: <FoodInvoicesPage /> },
      ...
      { path: 'tb/people/:id', element: <TBPeopleDetailPage /> },
      { path: 'tb/templates', element: <TBTemplatesPage /> },
      { path: 'tb/todo', element: <TBTodoPage /> },
