...
type LocalVariant = { tempId: string; id?: number; name: string; adult_price: number; child_price: number | null; description: string };
    ...
    try {
      ...
      const ops = [
        ...
        ...variants.map((lv, i) => {
          const payload = {
            name: lv.name,
            adult_price: lv.adult_price,
            child_price: lv.child_price ?? null,
    ...
    <DashboardContent>
      <Box sx={{ mb: 4, display: 'flex', alignItems: 'center', gap: 2 }}>
        ...
        <Button
          ...
          color="primary"
          onClick={handleSave}
          disabled={saving || variants.some((v) => !v.name.trim() || v.adult_price < 1)}
