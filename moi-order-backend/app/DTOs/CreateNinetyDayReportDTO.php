 ...
 */
readonly class CreateNinetyDayReportDTO
{
    public function __construct(
        ...
        public UploadedFile $oldSlip,
    ) {}

    public static function fromRequest(StoreNinetyDayReportRequest $request): self
    {
        return new self(
