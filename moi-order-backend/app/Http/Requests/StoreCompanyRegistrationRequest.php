...
/**
 * Principle: SRP — owns all validation + authorisation for a company registration submission.
...
class StoreCompanyRegistrationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'tm30'                 => ['required', File::image()->max(10 * 1024)],
        ];
    }
    ...
    public function withValidator(\Illuminate\Validation\Validator $validator): void
    {
        $validator->after(function (\Illuminate\Validation\Validator $v): void {
            ...
            if ($type->service->slug !== 'company-registration') {
                $v->errors()->add(
                    'service_type_id',
                    'The selected service type does not belong to the Company Registration service.'
                );
            }
        });
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'tm30.image'                 => 'The TM30 must be an image file.',
        ];
    }
    ...
    public function attributes(): array
    {
        return [
            ...
            'identity_card_front' => 'identity card front image',
            'identity_card_back'  => 'identity card back image',
            'tm30'                => 'TM30 image',
        ];
    }
}
