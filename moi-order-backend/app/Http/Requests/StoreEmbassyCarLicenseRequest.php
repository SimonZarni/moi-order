...
/**
 * Principle: SRP — owns all validation + authorisation for an embassy car license submission.
 ...
 */
class StoreEmbassyCarLicenseRequest extends FormRequest
{
    ...
    public function withValidator(\Illuminate\Validation\Validator $validator): void
    {
        $validator->after(function (\Illuminate\Validation\Validator $v): void {
            ...
            if ($type->service->slug !== 'embassy-car-license') {
                $v->errors()->add(
                    'service_type_id',
                    'The selected service type does not belong to the Embassy Car License service.'
                );
            }
        });
    }
