...
// Principle: OCP — embassy-residential-specific fields live here, not in service_submissions.
...
return new class extends Migration
{
    ...
    {
        Schema::create('embassy_residential_details', function (Blueprint $table): void {
            $table->id();
