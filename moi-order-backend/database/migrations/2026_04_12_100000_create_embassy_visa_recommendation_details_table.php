...
// Principle: OCP — embassy-visa-recommendation-specific fields live here, not in service_submissions.
...
return new class extends Migration
{
    ...
    {
        Schema::create('embassy_visa_recommendation_details', function (Blueprint $table): void {
            $table->id();
