...
Route::post('/profile/email/request-verification-otp', [ProfileController::class, 'requestVerificationOtp']);
Route::post('/profile/email/verify-current',           [ProfileController::class, 'verifyCurrentEmail']);
