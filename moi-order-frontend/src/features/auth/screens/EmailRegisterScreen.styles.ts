...
export const styles = StyleSheet.create({
  ...
  heroTitle: {
    fontSize: typography.xl, fontWeight: '800', color: colours.textOnDark,
  },
  ...
  subtitle: { fontSize: typography.sm, color: colours.textMuted, marginBottom: spacing.lg },
  ...
  backText: { fontSize: typography.sm, color: colours.textMuted },
  backLink: { fontSize: typography.sm, color: colours.primary, fontWeight: '600', marginLeft: spacing.xs },
});
