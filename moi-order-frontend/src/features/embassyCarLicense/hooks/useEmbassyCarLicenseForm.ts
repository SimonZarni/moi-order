...
export interface EmbassyCarLicenseFormState {
  fullName:          string;
  phone:             string;
...
export interface UseEmbassyCarLicenseFormResult {
  form: EmbassyCarLicenseFormState;
...
const FIELD_MAP: Record<string, keyof EmbassyCarLicenseFormState> = {
  full_name:           'fullName',
  phone:               'phone',
...
export function useEmbassyCarLicenseForm(): UseEmbassyCarLicenseFormResult {
  const [form, setForm] = useState<EmbassyCarLicenseFormState>({
    fullName:          '',
    phone:             '',
