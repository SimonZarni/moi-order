...
export interface EmbassyResidentialFormState {
  fullName:          string;
  phone:             string;
...
export interface UseEmbassyResidentialFormResult {
  form: EmbassyResidentialFormState;
...
const FIELD_MAP: Record<string, keyof EmbassyResidentialFormState> = {
  full_name:           'fullName',
  phone:               'phone',
...
export function useEmbassyResidentialForm(): UseEmbassyResidentialFormResult {
  const [form, setForm] = useState<EmbassyResidentialFormState>({
    fullName:          '',
    phone:             '',
