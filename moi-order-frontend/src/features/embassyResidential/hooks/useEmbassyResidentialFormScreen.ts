...
import {
  useEmbassyResidentialForm,
  UseEmbassyResidentialFormResult,
} from './useEmbassyResidentialForm';
import { submitEmbassyResidential } from '@/shared/api/submissions';
...
export interface UseEmbassyResidentialFormScreenResult {
  form: UseEmbassyResidentialFormResult['form'];
  price: number;
...
export function useEmbassyResidentialFormScreen(): UseEmbassyResidentialFormScreenResult {
