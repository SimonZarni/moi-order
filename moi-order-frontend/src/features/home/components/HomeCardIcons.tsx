...
export function CalendarIcon(): React.JSX.Element {
  return (
    <Svg width={40} height={40} viewBox="0 0 40 40">
      {/* Body */}
      <Rect x="2" y="7" width="36" height="30" rx="6" fill="#3d9e8c" />
      {/* Header strip */}
      <Rect x="2" y="7" width="36" height="12" rx="6" fill="#2e8070" />
      <Rect x="2" y="13" width="36" height="6" fill="#2e8070" />
      {/* Calendar grid area */}
      <Rect x="5" y="20" width="30" height="14" rx="3" fill="#e2f7f4" />
      {/* Binding pins */}
      <Rect x="11" y="3" width="4" height="9" rx="2" fill="#6ecfc2" />
      <Rect x="25" y="3" width="4" height="9" rx="2" fill="#6ecfc2" />
      {/* Date dots — row 1 */}
      <Circle cx="11" cy="25" r="2" fill="#6ecfc2" />
      <Circle cx="20" cy="25" r="2.5" fill="#ffb800" />
      <Circle cx="29" cy="25" r="2" fill="#6ecfc2" />
      {/* Date dots — row 2 */}
      <Circle cx="11" cy="31" r="2" fill="#6ecfc2" />
      <Circle cx="20" cy="31" r="2" fill="#6ecfc2" />
      <Circle cx="29" cy="31" r="2" fill="#6ecfc2" />
    </Svg>
  );
}
...
export function TicketIcon(): React.JSX.Element {
  return (
    <Svg width={40} height={40} viewBox="0 0 40 40">
      {/* Tag body */}
      <Path d="M5 4 L35 4 Q38 4 38 7 L38 24 L20 37 L2 24 L2 7 Q2 4 5 4 Z" fill="#5a7db5" />
      {/* Header accent */}
      <Path d="M5 4 L35 4 Q38 4 38 7 L38 15 L2 15 L2 7 Q2 4 5 4 Z" fill="#7aa0cc" />
      {/* Punch hole */}
      <Circle cx="20" cy="9.5" r="3.5" fill="#f0f6ff" />
      {/* Price lines */}
...
export function LocationIcon(): React.JSX.Element {
  return (
    <Svg width={40} height={40} viewBox="0 0 40 40">
      ...
      {/* Centre dot */}
      <Circle cx="20" cy="16" r="3.5" fill="#d4a030" />
    </Svg>
  );
}
...
export function PassportIcon(): React.JSX.Element {
  return (
    <Svg width={40} height={40} viewBox="0 0 40 40">
      {/* Booklet cover */}
      <Rect x="6" y="4" width="28" height="34" rx="3" fill="#6e6bbf" />
      {/* Spine */}
      <Rect x="6" y="4" width="6" height="34" rx="3" fill="#5452a0" />
      <Rect x="9" y="4" width="3" height="34" fill="#5452a0" />
      {/* Emblem circle */}
...
export function FoodIcon(): React.JSX.Element {
  return (
    <Svg width={40} height={40} viewBox="0 0 40 40">
      {/* Bowl body */}
      <Path d="M6 18 Q6 34 20 34 Q34 34 34 18 Z" fill="#e0613f" />
      {/* Bowl rim */}
      <Rect x="5" y="15" width="30" height="4" rx="2" fill="#f07855" />
      {/* Steam lines */}
      <Path d="M14 11 Q15 8 14 5" stroke="#e0613f" strokeWidth="2" strokeLinecap="round" fill="none" />
      <Path d="M20 10 Q21 7 20 4" stroke="#e0613f" strokeWidth="2" strokeLinecap="round" fill="none" />
      <Path d="M26 11 Q27 8 26 5" stroke="#e0613f" strokeWidth="2" strokeLinecap="round" fill="none" />
      {/* Shine */}
...
export function AirportIcon(): React.JSX.Element {
  return (
    <Svg width={40} height={40} viewBox="0 0 40 40">
      {/* Sky glow */}
      <Circle cx="20" cy="20" r="14" fill="rgba(58,143,212,0.20)" />
      {/* Plane body */}
      <Path d="M6 21 L28 10 Q34 8 33 14 L20 22 L22 33 L17 31 L16 23 L9 26 Z" fill="#3a8fd4" />
      {/* Wing highlight */}
      <Path d="M6 21 L28 10 Q31 9 31 11 L16 20 Z" fill="#7ac4e8" />
    </Svg>
  );
}
...
export function EmbassyIcon(): React.JSX.Element {
  return (
    <Svg width={40} height={40} viewBox="0 0 40 40">
      {/* Document body */}
      <Rect x="6" y="3" width="28" height="34" rx="4" fill="#c44d65" />
      {/* Header strip */}
      <Rect x="6" y="3" width="28" height="10" rx="4" fill="#a03a52" />
      <Rect x="6" y="9" width="28" height="4" fill="#a03a52" />
      {/* Text lines */}
      ...
      {/* Seal circle */}
      <Circle cx="27" cy="32" r="5.5" fill="#e07a95" />
      <Circle cx="27" cy="32" r="3.5" fill="#c44d65" />
...
export function BusIcon(): React.JSX.Element {
  return (
    <Svg width={40} height={40} viewBox="0 0 40 40">
      {/* Body */}
      <Rect x="3" y="12" width="34" height="18" rx="3" fill="#2a5cbf" />
      {/* Roof */}
      <Rect x="5" y="9" width="30" height="6" rx="3" fill="#3d72d9" />
      {/* Windows */}
      ...
      {/* Side stripe */}
      <Rect x="3" y="24" width="34" height="3" rx="0" fill="#3d72d9" opacity={0.55} />
      {/* Door */}
      <Rect x="18" y="25" width="5" height="5" rx="1" fill="#3d72d9" />
      ...
      {/* Undercarriage */}
      <Rect x="6" y="30" width="28" height="3" rx="1" fill="#1a3a80" />
      {/* Wheels */}
      <Circle cx="11" cy="34" r="4" fill="#1a3a80" />
      <Circle cx="11" cy="34" r="2" fill="#3d72d9" />
      <Circle cx="29" cy="34" r="4" fill="#1a3a80" />
      <Circle cx="29" cy="34" r="2" fill="#3d72d9" />
    </Svg>
  );
}
...
export function FlashIcon(): React.JSX.Element {
  return (
    <Svg width={40} height={40} viewBox="0 0 40 40">
      {/* Soft glow */}
      <Circle cx="20" cy="20" r="14" fill="rgba(61,191,173,0.20)" />
      {/* Bolt body */}
      <Path d="M23 3 L10 22 L19 22 L17 38 L30 19 L21 19 Z" fill="#3dbfad" />
      {/* Leading-edge highlight */}
      <Path d="M23 3 L10 22 L15 22 L22 8 Z" fill="#7adfd6" />
    </Svg>
  );
}
...
export function CompanyIcon(): React.JSX.Element {
  return (
    <Svg width={40} height={40} viewBox="0 0 40 40">
      {/* Building body */}
      <Rect x="6" y="13" width="28" height="25" rx="2" fill="#2a5cbf" />
      {/* Roof band */}
      <Rect x="4" y="10" width="32" height="6" rx="2" fill="#3d72d9" />
      {/* Windows row 1 */}
      ...
      {/* Flag pole */}
      <Rect x="19.5" y="3" width="1.5" height="9" rx="0.75" fill="#8bbde8" />
      {/* Flag */}
      <Path d="M21 3 L29 5.5 L21 8 Z" fill="#3a8fd4" />
    </Svg>
  );
}
