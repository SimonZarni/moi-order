...
export const TICKET_STATUS_COLOURS: Record<string, string> = {
  pending_payment: editorialPalette.amber,
...
export const styles = StyleSheet.create({
  ...
  orbLarge: {
    ...
    backgroundColor: editorialPalette.gold, opacity: 0.07, top: -60, right: -40,
  },
  orbSmall: {
    position: 'absolute', width: 80, height: 80, borderRadius: 40,
    backgroundColor: colours.tertiary, opacity: 0.05, bottom: 8, left: -16,
  },
  backBtn: {
  ...
  heroDate: { fontSize: typography.xs, color: colours.medium, marginTop: 5 },
  ...
  // ── Summary card ─────────────────────────────────────────────────────────
  summaryCard: {
    borderRadius: radius.xl, padding: spacing.md + 4,
    backgroundColor: colours.card, borderTopWidth: 2.5,
    borderTopColor: editorialPalette.gold,
    ...shadows.medium,
  },
  summaryRow: {
  ...
  summaryValue: { fontSize: typography.md, fontWeight: '800', color: colours.textOnLight },
  summaryDivider: { height: 1, backgroundColor: 'rgba(0,0,0,0.07)', marginVertical: spacing.sm },
  statusValue: { fontSize: typography.lg, fontWeight: '800' },
  totalValue: { fontSize: typography.xl, fontWeight: '900', color: editorialPalette.gold },

  // ── Items ─────────────────────────────────────────────────────────────────
  itemCard: { backgroundColor: colours.card, borderRadius: radius.xl, overflow: 'hidden', ...shadows.medium },
  itemRow: {
  ...
  itemQty: { fontSize: typography.xs, color: colours.textMuted, marginTop: 2 },
  itemSubtotal: { fontSize: typography.sm, fontWeight: '700', color: editorialPalette.gold },
