...
export type RootStackParamList = {
  ...
  MerchantMenuCategories: undefined;
  ...
  Cart: undefined;           // kept for backward compat; prefer CartAndOrders
  FoodOrders: undefined;     // kept for backward compat; prefer CartAndOrders
