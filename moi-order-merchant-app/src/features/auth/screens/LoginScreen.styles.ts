...
export const styles = StyleSheet.create({
  ...
  dividerText: { fontSize: typography.xs, color: colours.textMuted, fontWeight: '500' },
  outlineButton: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
  ...
  link: { color: colours.textMuted, fontSize: typography.sm, textAlign: 'center', paddingVertical: spacing.sm },
  linkBold: { color: colours.primary, fontWeight: '700' },

  // kept for type compat
  container: { flex: 1, padding: spacing.lg, justifyContent: 'center' },
  errorBannerLegacy: { backgroundColor: colours.error + '15', color: colours.error, padding: spacing.md, borderRadius: radius.lg, fontSize: typography.sm, marginBottom: spacing.md },
});
