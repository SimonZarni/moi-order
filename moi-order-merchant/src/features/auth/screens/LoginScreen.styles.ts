...
export const styles = StyleSheet.create({
  ...
  inputField: { flex: 1, paddingVertical: spacing.sm + 4, fontSize: typography.md, color: colours.textOnDark, backgroundColor: 'transparent', outlineWidth: 0, outlineStyle: 'none' },
